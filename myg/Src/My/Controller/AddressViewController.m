...
#define Margin 20
#define FontSize 14
@interface AddressViewController ()<UITableViewDataSource,UITableViewDelegate,UserAddressCellDelegate>{
...
//            if ([data[@"data"][@"status"] isEqualToString:@"2"] && [data[@"data"][@"status"] isEqualToString:@"3"]) {
//                
//            }
//            else{
                ...
                [array enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop) {
                    ...
                    DebugLog(@"**+**%@",_model.idd);
                    if (!IsStrEmpty(_model.game_name) || !IsStrEmpty(_model.qq)) {
                        _model = nil;
                    }else{
...
- (void)getExchange{
    if ([_index isEqualToString:@"8901"]) {
